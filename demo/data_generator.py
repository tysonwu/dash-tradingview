"""Random walk data for the hosted demo.
...
def generate_random_ohlc(v0, ret=0.05, n=500, t0='2026-01-01'):
...
def generate_random_series(v0, ret=0.05, n=500, t0='2026-01-01'):
...
def generate_intraday_series(v0, n, ret=0.002, t0='2026-01-01', step_seconds=60):
