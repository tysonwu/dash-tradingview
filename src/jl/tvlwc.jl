...
- `data` (optional): The data for the series. data has the following type: Array of lists containing elements 'seriesData', 'seriesType', 'seriesOptions', 'markers', 'priceLines'.
Those elements have the following types:
  ...
  - `markers` (Array of Dicts; optional)
  - `priceLines` (Array of Dicts; optional)s
