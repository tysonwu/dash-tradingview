...
- data (list; optional):
    ...
    _type = 'Tvlwc'
    @_explicitize_args
    def __init__(self, id=Component.UNDEFINED, data=Component.UNDEFINED, chartOptions=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'chartOptions', 'data']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'chartOptions', 'data']
